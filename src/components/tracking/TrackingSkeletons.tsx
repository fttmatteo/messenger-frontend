            ...
            {Array.from({ length: count }).map((_, i) => (
                <div key={i} className="p-3.5 border-b border-border/40 flex items-center justify-between gap-4 bg-background/30">
                    <div className="flex-1 min-w-0 space-y-2.5">
                        ...
                        <Skeleton static className="h-4 w-24 rounded-full bg-muted/10" />
                    </div>
                    <div className="flex items-center gap-2 shrink-0">
                        <Skeleton static className="h-4 w-4 rounded-full bg-muted/20" />
                        <Skeleton static className="h-4 w-4 rounded-full bg-muted/20" />
                    </div>
                </div>
            ))}
            ...
            <div className="p-4 border-b border-border/50 bg-background/40 flex items-center justify-between gap-3">
                <div className="flex items-center gap-2.5 flex-1">
                    ...
                    <div className="ml-1 space-y-1.5 flex-1">
                        ...
                        <Skeleton static className="h-4 w-20 rounded-full bg-muted/10" />
                    </div>
                </div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            {[1, 2, 3, 4].map(i => (
                                <div key={i} className="bg-muted/10 p-3 rounded-xl space-y-2 border border-border/30">
                                    <Skeleton static className="h-3 w-16 rounded bg-muted/5" />
                                    <Skeleton static className="h-5 w-10 rounded bg-muted/20" />
                                </div>
                            ))}
                        </div>
                    </CardContent>
                        ...
                        <div key={i} className="flex gap-4">
                            ...
                            <div className="flex-1 space-y-3">
                                <div className="flex justify-between items-center">
                                    ...
                                    <Skeleton static className="h-3.5 w-16 rounded bg-muted/5" />
                                </div>
                                <Skeleton static className="h-16 w-full rounded-2xl bg-muted/10 border border-border/40" />
                            </div>
                        </div>
                    ))}
                </div>
