                            ...
                            {[1, 2, 3].map((i, index) => (
                                <div key={i} className="flex gap-4 relative pb-8 last:pb-0">
                                    ...
                                    <div className="flex flex-col items-center absolute left-0 top-1.5 h-full">
                                        <Skeleton className="h-3.5 w-3.5 rounded-full bg-muted/30 z-10" />
                                        {index < 2 && (
                                    ...
                                    <div className="flex-1 pl-7 space-y-2.5">
                                        <Skeleton className="h-5.5 w-28 rounded-full bg-muted/20" />
                                        <div className="bg-muted/5 rounded-2xl p-4 space-y-3 border border-border/40">
                                            ...
                                            <Skeleton className="h-3 w-full rounded bg-muted/5" />
                                            <Skeleton className="h-3 w-4/5 rounded bg-muted/5" />
                                        </div>
                                    </div>
                                </div>
                            ))}
                ...
                <Card className="h-full flex flex-col border-border/50 bg-background/40">
                    <CardHeader className="px-5 py-4 space-y-3">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Skeleton className="h-6.5 w-20 rounded-full bg-muted/20" />
                        </div>
                    </CardHeader>
                    <CardContent className="p-3 pt-0 flex-1 flex flex-col min-h-0">
                        <Skeleton className="w-full flex-1 min-h-[250px] rounded-2xl bg-muted/10 border border-border/40 shadow-inner" />
                    </CardContent>
                </Card>
            </div>
        </div>
