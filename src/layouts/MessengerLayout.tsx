...
import { MobileOnlyGuard } from "@/shared/components/guards"
import { useNetwork } from "@/shared/hooks/use-network"
import { useNavigationGuard } from "@/shared/hooks/useNavigationGuard"
import { createLogger } from "@/shared/utils/logger"
import { Sheet, SheetContent, SheetHeader, SheetTitle, SheetTrigger, SheetDescription } from "@/shared/components/ui/sheet"
import { Separator } from "@/shared/components/ui/separator"
import { openSupportEmail, APP_CONFIG } from "@/shared/lib/app-config"
    ...
    return (
        <div className="flex flex-col h-app-screen w-full bg-background relative overflow-hidden transform-gpu">
            ...
            <main
                id="main-content"
                ref={mainRef}
                className="flex-1 flex flex-col min-h-0 overflow-y-auto overflow-x-hidden overscroll-none custom-scrollbar pb-safe"
